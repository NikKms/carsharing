...
export const { useFetchCarsQuery, useFetchAllcarsQuery, useFetchCarByIdQuery, reducer: carsReducer } = carsApi;
...
const carsSlice = createSlice({
    ...
    reducers: {
        ...
        setCars: (state, action) => {
            const newData = action.payload.filter(newCar => !state.dataCars.some(existingCar => existingCar.id === newCar.id));
...
export const { setPValue, setCars, setIdToModal } = carsSlice.actions;
